  ...
  return (
    <div className="h-full flex flex-col overflow-hidden relative">
        ...
        <div className="flex-1 mt-3 overflow-y-auto">
          {communities.map((community) => (
            <div
              key={community.id}
              className={`${
                community.id !== "1" ? "pt-6 sm:pt-8 border-t-4 sm:border-t-8 border-gray-100" : ""
              } mb-4 sm:mb-5 w-full cursor-pointer hover:bg-gray-50 rounded-lg p-2 transition-colors`}
              onClick={() => handleCommunityClick(community)}
            >
              {/* Community Header */}
              <div className="flex items-center gap-2 sm:gap-3 mb-1">
                <div className="h-12 w-12 sm:h-15 sm:w-15 border-2 border-gray-300 rounded-lg flex items-center justify-center bg-gray-100 flex-shrink-0">
                  <HiUserGroup className="h-6 w-6 sm:h-8 sm:w-8 text-gray-600" />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between w-full">
                    <p className="font-medium text-sm sm:text-base truncate">{community.name}</p>
                  </div>
              ...
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                />
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-sm sm:text-base truncate">{community.announcement.title}</p>
                  <p className="text-xs sm:text-sm text-gray-500 truncate">
              ...
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                ...
                />
                <div className="flex-1 min-w-0">
                  <p className="font-medium text-sm sm:text-base truncate">General group</p>
                  <p className="text-xs sm:text-sm text-gray-500 truncate">
              ...
              {community.groups.map((group) => (
                <div key={group.id} className="flex items-center gap-2 sm:gap-3 py-2 sm:py-3">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 lg:left-160 h-12 w-12 sm:h-14 sm:w-14 bg-blue-500 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors shadow-lg z-50"
      >
