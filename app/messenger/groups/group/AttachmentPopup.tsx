...
import { FaCalendarAlt, FaPollH } from "react-icons/fa";
...
export function AttachmentPopup({
  ...
  const attachmentOptions = [
    ...
    { id: "poll", label: "Poll", icon: FaPollH, color: "text-pink-500" },
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ width: "789px", marginLeft: "-53px" }}
      >
        <div className="flex flex-cols-1 gap-18">
