...
export function ComposeMessagePopup({
  onClose,
  onBack,
    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-[500px] h-[500px] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          {/* Compose Message */}
          <div>
            <p className="text-black text-[14px] mb-3">Compose message</p>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <span className="text-black text[14px]">Add Images (5 max)</span>
              <CiCircleInfo className="h-4 w-4 text-gray-400" />
            </div>
                ...
                <div key={index} className="relative">
                  {index < 3 ? (
                    <div className="w-20 h-20 bg-gray-200 rounded-lg relative overflow-hidden">
                      ...
                      >
                        <RiDeleteBin5Line  className="h-15 w-15 text-white/50" />
                      </button>
                    </div>
                  ) : (
