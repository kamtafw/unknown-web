...
export function HostLive({ onJoin }: HostLiveProps) {
  return (
    <div className="h-full bg-white flex flex-col">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="mb-4">
            <div className="flex items-center">
              <h1 className="text-xl font-semibold mr-3">Your Live Sessions</h1>
              <Image
                src="/live.png"
                alt="Live"
                width={24}
            ...
            <p className="text-gray-600">Start your live session now</p>
          </div>
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search your live sessions"
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        <div className="bg-[#2D3B5D] rounded-lg p-4">
          <div className="flex items-start mb-3">
            ...
            <div>
              <p className="text-white text-sm text-[12px]">Host:</p>
              <p className="text-white font-semibold text-[18px]">You</p>
            </div>
          </div>
