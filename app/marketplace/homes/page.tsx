...
export default function FriendSuggestionsPage() {
  const suggestions = [
    { id: 1, name: "Cameron Williamson", username: "@_reddy_sohan", isFollowing: false },
    { id: 2, name: "Devon Lane", username: "@_jatin_garewal", isFollowing: true },
    { id: 3, name: "Eleanor Pena", username: "@_dave", isFollowing: false },
    { id: 4, name: "Ralph Edwards", username: "@_angle_talu", isFollowing: false },
    { id: 5, name: "Kathryn Murphy", username: "@_dr_nick", isFollowing: false },
    { id: 6, name: "Kristin Watson", username: "@_roy_akansha", isFollowing: false },
    { id: 7, name: "Roland Richards", username: "@riley_cuso", isFollowing: false },
    { id: 8, name: "Jenny Wilson", username: "@_arya_deewana", isFollowing: false },
    { id: 9, name: "Wade Warren", username: "@_agel_jolie", isFollowing: false },
    { id: 10, name: "Robert Fox", username: "@_deepak_404_found", isFollowing: false },
    { id: 11, name: "Ariene McCoy", username: "@Ariene_McCoy", isFollowing: false },
    { id: 12, name: "Lucas Brown", username: "@lucas_brown", isFollowing: false },
  ];

  return (
    <div className="flex justify-center ml-1 mb-4 px-2 sm:px-4 lg:ml-5 lg:mb-14">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="flex flex-col justify-center cursor-pointer">
                  ...
                  <span className="text-gray-500 text-xs sm:text-sm">{person.username}</span>
                </div>
              </div>
