...
//       <div className="bg-white w-150 max-h-[97vh] overflow-hidden animate-slide-up">
//         {/* Header */}
...
//           {/* Store info */}
//           <div className="bg-white px-4 py-4  border-gray-100">
...
//               {/* Product image */}
//               <div className="w-30 h-30   flex items-center justify-center overflow-hidden flex-shrink-0">
//                 <Image
//                   src={order.image}
...
//             </div>
//             {/* Delivery date */}
//             <div className="text-center mb-3 mt-15">
