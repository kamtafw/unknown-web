...
//           <h1 className="text-2xl font-semibold text-gray-900 mb-3">Account</h1>
...
//           {/* Marketplace Banner */}
//           <div className="bg-gradient-to-r from-gray-800 to-gray-700 rounded-lg p-4 mb-3 relative overflow-hidden">
...
//               <div className="flex items-center space-x-3 mb-1 pb-1 border-b border-gray-100">
...
//           {/* My Orders */}
//           <div
//             className="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors cursor-pointer border-t border-gray-100"
//             onClick={onMyOrdersClick}
//           >
//             <div className="flex items-center space-x-4">
//               <div className="w-6 h-6 flex items-center justify-center">
//                 <FaTruckFast className="w-5 h-5 text-gray-600" />
//               </div>
//               <div>
...
//             <div className="flex items-center space-x-4">
//               <div className="w-6 h-6 flex items-center justify-center">
//                 <FaLocationDot className="w-5 h-5 text-gray-600" />
//               </div>
//               <div>
...
//           >
//             <div className="flex items-center justify-between p-4 hover:bg-gray-50 transition-colors cursor-pointer border-t border-gray-100">
//               <div className="flex items-center space-x-4">
//                 <div className="w-6 h-6 flex items-center justify-center">
//                   <BsCreditCard2FrontFill className="w-5 h-5 text-gray-600" />
//                 </div>
//                 <div>
...
//               <div className="flex items-center space-x-4">
//                 <div className="w-8 h-6 flex items-center justify-center bg-white rounded">
//                   <Image
//                     src="/visa.svg"
//                     alt="Visa card"
//                     width={24}
