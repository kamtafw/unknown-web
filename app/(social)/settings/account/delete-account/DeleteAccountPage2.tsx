...
interface DeleteAccountPage2Props {
  onBack: () => void;
  onNext: () => void;
}

export default function DeleteAccountPage2({ onBack,  }: DeleteAccountPage2Props) {
    ...
    <div className="flex ml-3 justify-center sm:justify-start w-full">
      <div className="w-full max-w-[530px] h-[796px] max-h-[100vh] bg-white text-gray-900 overflow-auto shadow-md rounded-lg border border-gray-200">
        ...
        <div className="px-2 sm:px-4 py-3 flex flex-col items-center">
          ...
          <p className="mt-2 text-sm text-gray-500 text-center text-[14px]">
