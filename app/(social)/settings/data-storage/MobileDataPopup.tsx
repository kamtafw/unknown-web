...
interface MobileDataPopupProps {
  onClose: () => void;
  onSave: (selections: { photos: boolean; videos: boolean; audio: boolean; documents: boolean }) => void;
}

export default function MobileDataPopup({ onClose, onSave }: MobileDataPopupProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg w-full max-w-[400px]">
      <h2 className="text-lg font-semibold mb-4">When using mobile data</h2>
