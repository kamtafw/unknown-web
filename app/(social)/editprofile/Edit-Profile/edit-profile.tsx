      ...
      <div className="w-full max-w-[530px] bg-white overflow-auto shadow-md lg:w-[546px] lg:h-[796px]">
        ...
        <div className="px-3 mt-3 sm:px-4 sm:mt-4">
          <div className="bg-white p-3 sm:p-4">
            ...
            <div className="flex justify-between items-center py-2">
              <span className="text-gray-900 text-sm sm:text-base">Username</span>
              <div className="flex items-center gap-2 font-semibold">
                <span
                  className="cursor-pointer text-gray-900 text-sm sm:text-base"
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <div className="flex items-center gap-2 font-semibold">
                ...
                >
                  A product Designer who likes explore...
                </span>
                <ChevronRight
                  className="text-gray-900 cursor-pointer w-5 h-5 sm:w-6 sm:h-6"
                  onClick={() => onFieldEdit("editBio")}
            ...
            <div className="flex justify-between items-center py-2">
              ...
              <span className="text-gray-500 text-sm sm:text-base">
                Cameronwill@example.com
              </span>
            </div>
            <div className="flex justify-between items-center py-2">
              <span className="text-gray-900 text-sm sm:text-base">Phone No</span>
              <div className="flex items-center gap-2 font-semibold">
                <span
                  className="cursor-pointer text-gray-900 text-sm sm:text-base"
            ...
            <div className="flex justify-between items-center py-2">
              <span className="text-gray-900 text-sm sm:text-base">Date of birth</span>
              <div className="flex items-center gap-2 font-semibold">
                <span
                  className="cursor-pointer text-gray-900 text-sm sm:text-base"
            ...
            <label className="flex justify-between items-center py-2 cursor-pointer">
              <span className="text-gray-900 text-sm sm:text-base">Show date of birth</span>
            ...
            <div className="flex justify-between items-center py-2">
              <span className="text-gray-900 text-sm sm:text-base">Locations</span>
              <div className="flex items-center gap-2 font-semibold">
                <span
                  className="cursor-pointer text-gray-900 text-sm sm:text-base"
          ...
          <div className="mt-4">
            ...
            <div className="flex items-center gap-2 py-2">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500 text-sm">https://www.behance.net/stanleyoffiah</p>
              </div>
              <ChevronRight
                className="text-gray-900 cursor-pointer w-5 h-5 sm:w-6 sm:h-6"
                onClick={() => onFieldEdit("editPortfolio")}
            ...
            <div className="flex items-center gap-2 py-2">
              ...
              <div className="flex-1">
                <span
                  className="text-gray-900 font-semibold text-sm sm:text-base cursor-pointer"
                  onClick={() => onFieldEdit("editShoppingList")}
                >
                  My Shopping List
                </span>
                <p className="text-gray-500 text-sm">https://example.com/shopping-list</p>
              </div>
              <ChevronRight
                className="text-gray-900 cursor-pointer w-5 h-5 sm:w-6 sm:h-6"
                onClick={() => onFieldEdit("editShoppingList")}
