        ...
        <div className="px-3 py-3 sm:px-4 sm:py-4">
          ...
          <div className="mb-4 mt-6">
            ...
            <div className="flex items-center border border-gray-300 rounded-md px-3 py-2">
              ...
              <span className="text-gray-500 text-sm sm:text-base">@Cameron_Williamson</span>
            </div>
          </div>
          <div className="mb-4 mt-6">
            <label
            ...
            <p className="text-gray-500 text-xs mb-2 sm:text-sm">
              ...
              username will also change your profile link. You can only change your username
              once every 180 days.
            </p>
            <div className="flex items-center border border-gray-300 rounded-md px-3 py-2">
              <User size={16} className="text-gray-500 mr-2 sm:w-5 sm:h-5" />
          ...
          <button
            type="button"
            className="w-full py-2 bg-[#6A88D1] text-white rounded-md hover:bg-[#425483] text-sm sm:text-base"
            onClick={() => setShowReservedPopup(true)}
          >
            Save
          </button>
        </div>
