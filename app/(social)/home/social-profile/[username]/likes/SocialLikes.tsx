...
export default function SocialLikes() {
      ...
      <div className="w-full lg:max-w-4xl space-y-0">
        {posts.map((post) => (
          ...
          >
            ...
            {/* Repost Header - only for David Brown's post (without more options) */}
            {post.id === 6 && (
            ...
            {/* Original Post in Border - only for David Brown's post */}
            <div
              className={cn(
                post.id === 6
            ...
            >
              {/* Only show this header for the repost (post.id === 6) */}
              {post.id === 6 && (
                <div className="flex items-start justify-between mb-2 sm:mb-3">
                  <div className="flex items-start flex-1 min-w-0">
                    <div
