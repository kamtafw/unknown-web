...
const WAVEFORM_BARS = [
	5, 9, 6, 13, 8, 16, 10, 5, 12, 17, 7, 14, 9, 6, 11, 15, 8, 13, 5, 10, 16, 7, 12, 9, 14, 6, 11, 17,
	8, 4, 13, 10, 15, 7, 9, 12, 6, 14, 8, 11, 16, 5, 10, 9, 13, 7, 15, 4, 12, 8,
]
...
export function VoiceMessagePlayer({
	...
	return (
		<div className="flex flex-col gap-1.5 min-w-64 max-w-72">
			...
			<div className="flex items-center gap-2.5">
				...
				<Avatar.Root className="relative h-7 w-7 shrink-0 rounded-full overflow-hidden bg-muted flex items-center justify-center">
					...
					/>
					<Avatar.Fallback className="text-[10px] font-medium text-muted-foreground">
						{senderInitials}
					</Avatar.Fallback>
