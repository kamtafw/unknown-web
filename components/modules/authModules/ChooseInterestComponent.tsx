...
import { useGetListOfInterests, useSetUserInterests } from '@/services/queryHooks/useUserAuthService';
...
const ChooseInterestComponent = () => {
    ...
    return (
        <>
            <div className='flex flex-col w-full max-w-[430px] gap-[32px]'>
              ...
              ${isSelected
                ...
                <div className='w-full flex flex-col lg:flex-row items-center justify-between gap-[20px]'>
                    ...
                    <Button type='button' onClick={handleSubmit} className='bg-[#6A88D1] text-base font-semibold text-[#FFFFFF] py-[14px] px-[24px] rounded-[12px] cursor-pointer w-full lg:w-1/2 h-[52px]'>
            ...
            {
                displaySuggestions && <FriendsSuggestionModal setDisplaySuggestions={setDisplaySuggestions} displaySuggestions={displaySuggestions} />
            }
        </>
    );
}
