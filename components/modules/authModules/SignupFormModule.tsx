            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="w-full flex flex-col gap-[32px]">
                                                ...
                                                {isValid ? (
                                                    <div className="min-w-[12px] min-h-[12px] rounded-full border border-[#6A88D1] flex items-center justify-center">
                                                        <svg width="6" height="5" viewBox="0 0 6 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M0.900391 2.79922L2.30039 4.19922L5.10039 1.19922" stroke="#6A88D1" strokeWidth="0.6" strokeLinecap="round" strokeLinejoin="round" />
                                                        </svg>
                    ...
                    <div className="flex flex-col items-center gap-[24px]">
                        ...
                        <Link href="/login" className="text-base text-center text-[#1F2937] font-bold cursor-pointer">Already a user? <span className="text-[#6A88D1]">Sign in</span></Link>
                    </div>
                </form>
            </Form>
            <Toaster position="top-right" />
            {
                displayConfirmation && <SignupConfirmationModule displayConfirmation={displayConfirmation}
