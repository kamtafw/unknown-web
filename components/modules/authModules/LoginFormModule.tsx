            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="w-full flex flex-col gap-[32px]">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="w-full">
                                    <Label className="text-base text-[#191919] font-medium">Email or Phone</Label>
                                    <FormControl>
                    ...
                    <div className="flex flex-col items-center gap-[24px]">
                        <Button type="submit" className="py-[14px] flex items-center justify-center bg-[#6A88D1] rounded-[12px] text-[#FFFFFF] text-base font-semibold h-[52px] hover:bg-[#425483] w-full max-w-[384px]">
                            {/* {isPending ? <CustomLoader /> : 'Sign Up'} */}
                            Sign in
                        </Button>
                        <Link href="/signup" className="text-base text-center text-[#1F2937] font-bold cursor-pointer">Already a user? <span className="text-[#6A88D1]">Sign Up</span></Link>
                    </div>
                </form>
            </Form>
